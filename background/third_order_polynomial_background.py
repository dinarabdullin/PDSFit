...
class ThirdOrderPolynomialBackground(Background):
    ...
    def __init__(self):
        super().__init__() 
        self.parameter_names = ['c1', 'c2', 'c3', 'scale_factor']
        self.parameter_full_names = {'c1': 'c1', 'c2': 'c2', 'c3': 'c3', 'scale_factor': 'Scale factor'}
    ...
    def get_fit(self, t, background_parameters, s_intra):
        return signal_model(t, background_parameters['c1'], background_parameters['c2'], background_parameters['c3'], 
                            background_parameters['scale_factor'], s_intra)
    
    def get_background(self, t, background_parameters, modulation_depth=0):
        return background_model(t, background_parameters['c1'], background_parameters['c2'], background_parameters['c3']) * (1-background_parameters['scale_factor']*modulation_depth)