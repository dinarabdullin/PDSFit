...
class Peldor_4p_rect(Experiment):
    """Four-pulse ELDOR with rectangular detection and pump pulses."""
    ...
    def pump_probability(self, resonance_frequencies):
        """Computes pump probabilities for given resonance frequencies."""
    ...
    def get_pump_bandwidth(self, ranges=()):
        ...
        pump_bandwidth = {}
        pump_bandwidth["freq"] = frequencies
        pump_bandwidth["prob"] = probabilities
