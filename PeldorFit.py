...
if __name__ == '__main__':
    ...
    if mode['fitting']:
        ...
        # Display the statistics describing the goodness of fit
        print_fit_statistics(fit_statistics)
    ...
    if mode['error_analysis']:
        ...
        if not mode['fitting']:
            optimized_parameters, parameter_errors = error_analyzer.load_optimized_parameters()
