...
const["model_parameter_labels"] = {
	...
	"xi_mean"     : [r"$\langle\mathit{\xi}\rangle$", "(°)"],
	"xi_width"    : [r"$\mathit{\Delta\xi}$", "(°)"], 
	"phi_mean"    : [r"$\langle\mathit{\varphi}\rangle$", "(°)"], 
	"phi_width"   : [r"$\mathit{\Delta\varphi}$", "(°)"],
    "alpha_mean"  : [r"$\langle\mathit{\alpha}\rangle$", "(°)"],
    "alpha_width" : [r"$\mathit{\Delta\alpha}$", "(°)"], 
    "beta_mean"   : [r"$\langle\mathit{\beta}\rangle$", "(°)"],
    "beta_width"  : [r"$\mathit{\Delta\beta}$", "(°)"], 
    "gamma_mean"  : [r"$\langle\mathit{\gamma}\rangle$", "(°)"],
    "gamma_width" : [r"$\mathit{\Delta\gamma}$", "(°)"],
    "rel_prob"    : [r"$\mathit{w}$", ""],
