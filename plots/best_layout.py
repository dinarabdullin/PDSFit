...
def best_layout(w, h, n):
    """Find the best layout of multiple subplots for a given figure size."""
...
def best_square_size(x, y, n):
    """ Given a rectangle with width and height, fill it with n squares of equal size such that the squares cover as much of the rectangle's area as possible. 
